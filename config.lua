...
Config.percentage = math.random(20,30) -- Percentage of money to wash
Config.itemname = 'moneywash_card' -- Item name to use for the money wash
Config.progressType = "bar" -- bar | circle | none
